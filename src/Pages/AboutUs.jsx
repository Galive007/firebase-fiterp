...
const AboutUs = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-red-300 via-green-500 to-red-300 text-center">
            ...
            <div className="mt-10">
                <button
                    ...
                    className="btn btn-outline btn-danger animate-[pulse_2s_infinite]"
                >
                    Notify Me
                </button>
            </div>
            ...
            <div className="absolute bottom-6 text-white text-sm animate-pulse">
                Developed by <span className="font-bold">Al amin 💎</span>
            </div>
        </div>
    );
};
